...
describe('Node Functionality', function() {
    ...
    rimraf(datadir + '/regtest', function(err) {
      ...
      node.start(function(err) {
        ...
        var syncedHandler = function() {
          if (node.services.SIKENd.height === 150) {
            node.services.SIKENd.removeListener('synced', syncedHandler);
            done();
          }
        };

        node.services.SIKENd.on('synced', syncedHandler);
  ...
  describe('Bus Functionality', function() {
    it('subscribes and unsubscribes to an event on the bus', function(done) {
      ...
      bus.on('SIKENd/hashblock', function(data) {
        bus.unsubscribe('SIKENd/hashblock');
        if (blockExpected) {
  ...
  describe('Address Functionality', function() {
    ...
    before(function(done) {
      ...
      var startHeight = node.services.SIKENd.height;
      node.services.SIKENd.on('tip', function(height) {
    ...
    describe('Mempool Index', function() {
      ...
      it('will update the mempool index after new tx', function(done) {
        ...
        node.services.SIKENd.sendTransaction(tx.serialize(), function(err, hash) {
