...
WebService.prototype.transformHttpsOptions = function() {
  ...
  var caCerts = [];
  if (this.httpsOptions.ca != null) {
      for(var i = 0; i < this.httpsOptions.ca.length; i++) {
        caCerts.push(fs.readFileSync(this.httpsOptions.ca[i]));
      }
  }
