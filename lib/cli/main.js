...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `SIKENcore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ SIKENcore-node add wallet-service');
      console.log('    $ SIKENcore-node add SIKEN-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ SIKENcore-node remove wallet-service');
      console.log('    $ SIKENcore-node remove SIKEN-api');
      console.log();
    });
